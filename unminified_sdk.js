/*1536269476,,JIT Construction: v4286586,en_US*/
/**
...
try {
            ...
            with(this) {
                ...
                __d("JSSDKConfig", [], {
                    ...
                    "api": {
                        ...
                        "whitelist": ["Canvas", "Canvas.Prefetcher", "Canvas.Prefetcher.addStaticResource", "Canvas.Prefetcher.setCollectionMode", "Canvas.getHash", "Canvas.getPageInfo", "Canvas.hideFlashElement", "Canvas.scrollTo", "Canvas.setAutoGrow", "Canvas.setDoneLoading", "Canvas.setHash", "Canvas.setSize", "Canvas.setUrlHandler", "Canvas.showFlashElement", "Canvas.startTimer", "Canvas.stopTimer", "Data", "Data.process", "Data.query", "Data.waitOn", "Event", "Event.subscribe", "Event.unsubscribe", "Music.flashCallback", "Music.init", "Music.send", "Payment", "Payment.cancelFlow", "Payment.continueFlow", "Payment.init", "Payment.lockForProcessing", "Payment.unlockForProcessing", "Payment.parse", "Payment.setSize", "ThirdPartyProvider", "ThirdPartyProvider.init", "ThirdPartyProvider.sendData", "UA", "UA.nativeApp", "XFBML", "XFBML.RecommendationsBar", "XFBML.RecommendationsBar.markRead", "XFBML.parse", "addFriend", "api", "getAccessToken", "getAuthResponse", "getLoginStatus", "getUserID", "init", "login", "logout", "publish", "share", "ui", "JSON", "JSON.parse", "JSON.stringify", "AppEvents", "AppEvents.activateApp", "AppEvents.logEvent", "AppEvents.logPurchase", "AppEvents.EventNames", "AppEvents.ParameterNames", "AppEvents.logPageView", "AppEvents.setUserID", "AppEvents.getUserID", "AppEvents.clearUserID", "AppEvents.updateUserProperties", "AppEvents.setAppVersion", "AppEvents.getAppVersion", "AppEvents.clearAppVersion", "RankingService.hidePlugin", "RankingService.showPlugin", "CustomerChat.hideDialog", "CustomerChat.showDialog", "CustomerChat.hide", "CustomerChat.show", "CustomerChat.update"]
                    }
                });
                __d("JSSDKXDConfig", [], {
                    "XdUrl": "\/connect\/xd_arbiter.php?version=C-2866573-4286586-20180906133409",
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/0P3pVtbsZok.js?version=C-2866573-4286586-20180906133409",
                    "Flash": {
                ...
                __d("invariant", ["TAAL", "ex", "sprintf"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a, b) {
                        ...
                        if (!a) {
                            ...
                            var i = new Error(g.blameToPreviousFrame(j.apply(undefined, [c].concat(e))));
                ...
                __d("ErrorUtils", ["Env", "LogviewForcedKeyError", "eprintf", "erx", "removeFromArray", "sprintf"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    var P = {
                        ...
                        addListener: function(a, b) {
                            b === void 0 && (b = !1), u.push(a), b || ES(w, "forEach", !0, function(b) {
                            ...
                            try {
                                ...
                                if (f == null) try {
                                    ...
                                    if (c != null)
                                        ...
                                        var k = c,
                                            n = {};
                                        ES(ES("Object", "keys", !1, k), "map", !0, function(a, b) {
                                            b = k[a];
                                            n[a] = j(b)
                                        });
                                        i = n
                                ...
                                d && (i.extra[ES("Array", "from", !1, d).toString().substring(0, 100)] = "args");
                                i.guard = y[0];
                                i.guardList = y.slice();
                ...
                __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    g.provide("", {
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    if (l) {
                        ...
                        if (b) {
                            ...
                            "transferSize" in b && (n.transferSize = Number(b.transferSize), a && (n.transferSize += Number(a.transferSize)));
                            g.debug("sdkperf: it took %s ms and %s bytes to load %s", n.fetchTime, n.transferSize, o);
                            m = b.startTime;
                            n.ns = j.getSDKNS();
                            d = j.getSDKAB();
                            d && (n.ab = d);
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4286586","namespace":"FB","message":"' + e.message + '"}}');
}